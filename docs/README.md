...
Using this option will IDNA-convert host using non-ASCII characters.
...
$uri->toString(Uri::IDNA); // -> "https://xn--zca0cg32z7rau82strvd.com"

$clone = $uri->withHost('œüç∂', Uri::IDNA);
...
echo $uri->toString(Uri::IDNA | Uri::REQUIRE_PORT | Uri::ABSOLUTE_PATH | Uri::NORMALIZE_PATH); // -> "https://xn--zca0cg32z7rau82strvd.com:443/a/to/something"
```
